...
<div class="mx-5">
  <p class="text-normal">
    <a href="/about" class="underline text-sky-600"
      >つながる学生のためのプラットフォーム、Schoolinkを知る→</a
    >
  </p>
  ...
  {#if loading}
    <div
      class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-5 gap-6 animate-pulse"
    >
    ...
    <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-5 gap-6">
      ...
      {#each filteredProjects as project}
        <a href={`/projects/${project.projectId}`}>
          <div>
            <img
              class="text-sky-600 flex items-center justify-center text-6xl rounded-xl bg-gray-200 aspect-4/3 border border-gray-500"
              src={project.thumbnail}
              alt="thumbnail"
              loading="lazy"
            />
            <p class="text-xl w-full text-left mt-2 truncate">
              {project.title}
            </p>
            <div class="flex items-center gap-1 mt-2">
              <img
                ...
                alt="avatar"
                class="size-7 border border-gray-500 rounded-full aspect-square"
                loading="lazy"
              />
              ...
              <img
                ...
                alt="avatar"
                class="size-7 border border-gray-500 rounded-md aspect-square"
                loading="lazy"
              />
