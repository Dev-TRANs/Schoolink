  ...
  <div class="space-y-4 {className}">
      ...
      {#each value as button, index}
        <div class="flex space-x-2 items-start">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
              <div>
                <input
                  ...
                  class="w-full px-3 py-2 border {showError && error ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                />
              </div>
              <div>
                <input
          ...
          <button
            ...
            disabled={disabled}
            aria-label="ボタンを削除"
            class="mt-1 p-2 border border-gray-300 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 {disabled ? 'opacity-50 cursor-not-allowed' : ''}"
          >
    ...
    <div class="flex justify-between">
      <button
        ...
        on:click={addButton}
        disabled={disabled}
        class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 {disabled ? 'opacity-50 cursor-not-allowed' : ''}"
      >
